...
interface PurchaseOrdersDataTableProps {
  columns: ColumnDef<TPurchaseOrder>[];
  data: TPurchaseOrder[];
}
...
const PurchaseOrdersDataTable = ({
  ...
  const debouncedPOFilter = useDebounce(columnFilters, 300);
  ...
  const table = useReactTable({
    ...
    state: {
      sorting,
      columnFilters: debouncedPOFilter,
    },
    onColumnFiltersChange: setColumnFilters,
    onSortingChange: setSorting,
  });

  const canAddPurchaseOrder = usePermission(
      ...
      <div className="flex justify-between">
        <div className="flex items-center gap-2">
          <div className="relative">
            <Input
              className="peer h-8 w-[267px] ps-9"
              ...
              onChange={(event) =>
                table.setColumnFilters([
                  { id: "purchase_order_number", value: event.target.value },
                ])
              }
            />
