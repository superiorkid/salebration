...
class PurchaseOrderRejectedNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ->subject("Purchase Order {$this->purchaseOrder->purchase_order_number} Rejected by Supplier")
    ...
    public function toArray(object $notifiable): array
    {
        return [
            ...
            'message' => "Purchase Order #{$this->purchaseOrder->purchase_order_number} was rejected by supplier",
        ];
    }
}
